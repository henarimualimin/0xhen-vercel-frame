...
app.frame('/', (c) => {
  ...
  return c.res({
    ...
    intents: [
      ...
      <Button value="Done Submit" onClick={handleWalletSubmit}>
        📤Submit Wallet
      </Button>,
      ...
      <Button.Link href="https://warpcast.com/~/compose?text=Frame%20By%20@0xhen%20give%201%20word%20or%20put%20a%20space%20so%20that%20a%20frame%20image%20appears%20beri%201%20kata%20atau%20beri%20spasi%20agar%20muncul%20gambar%20bingkai">
        🔍Share
      </Button.Link>,
